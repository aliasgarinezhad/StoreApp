...
class BarcodeSpecialTest {

    @get:Rule
    var activity = createAndroidComposeRule<BarcodeSpecial>()
    ...
    private fun checkResults() {
        ...
        for (i in 0 until 5) {
            ...
            val text = activity.activity.memory.erpData.warehousesIDsToTitles[departmentNumber] +
