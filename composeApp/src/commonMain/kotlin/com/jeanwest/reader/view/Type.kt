...
fun Typography(): Typography {
    ...
    val bodyFontFamily = FontFamily(
        org.jetbrains.compose.resources.Font(Res.font.sans_regular)
    )

    val displayFontFamily = FontFamily(
        org.jetbrains.compose.resources.Font(Res.font.sans_bold)
    )
    ...
    return Typography(
        ...
        titleSmall = baseline.titleSmall.copy(fontFamily = displayFontFamily, color = primaryLight),
